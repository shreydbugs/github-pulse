const cityMap = {
  "san francisco": { lat: 37.7749, lon: -122.4194, country: "United States", name: "San Francisco" },
  ...
  "bangalore": { lat: 12.9716, lon: 77.5946, country: "India", name: "Bangalore" },
  "bengaluru": { lat: 12.9716, lon: 77.5946, country: "India", name: "Bangalore" },
  "mumbai": { lat: 19.0760, lon: 72.8777, country: "India", name: "Mumbai" },
  "pune": { lat: 18.5204, lon: 73.8567, country: "India", name: "Pune" },
  "seattle": { lat: 47.6062, lon: -122.3321, country: "United States", name: "Seattle" },
  "austin": { lat: 30.2672, lon: -97.7431, country: "United States", name: "Austin" },
  "sydney": { lat: -33.8688, lon: 151.2093, country: "Australia", name: "Sydney" },
  "melbourne": { lat: -37.8136, lon: 144.9631, country: "Australia", name: "Melbourne" },
  "toronto": { lat: 43.6510, lon: -79.3470, country: "Canada", name: "Toronto" },
  "vancouver": { lat: 49.2827, lon: -123.1207, country: "Canada", name: "Vancouver" },
  ...
  "sao paulo": { lat: -23.5505, lon: -46.6333, country: "Brazil", name: "Sao Paulo" },
  "lagos": { lat: 6.5244, lon: 3.3792, country: "Nigeria", name: "Lagos" },
  "tel aviv": { lat: 32.0853, lon: 34.7818, country: "Israel", name: "Tel Aviv" },
  "dubai": { lat: 25.2048, lon: 55.2708, country: "United Arab Emirates", name: "Dubai" },
  "seoul": { lat: 37.5665, lon: 126.9780, country: "South Korea", name: "Seoul" },
  ...
  "usa": { lat: 37.0902, lon: -95.7129, country: "United States", name: "United States" },
  "united states": { lat: 37.0902, lon: -95.7129, country: "United States", name: "United States" },
  "uk": { lat: 55.3781, lon: -3.4360, country: "United Kingdom", name: "United Kingdom" },
  ...
  "brazil": { lat: -14.2350, lon: -51.9253, country: "Brazil", name: "Brazil" },
};
...
export function resolveLocation(locationStr) {
  ...
  if (cityMap[normalized]) {
    return { ...cityMap[normalized], coordinates: [cityMap[normalized].lat, cityMap[normalized].lon] };
  }
